...
import { loginLimiter, registrationLimiter } from '../../middleware/rateLimit.js';
...
router.post('/register', registrationLimiter, rejectProhibitedCredentialFields, validateRequest(registerSchema), asyncHandler(handleRegister));
router.post('/pending-registration', registrationLimiter, rejectProhibitedCredentialFields, validateRequest(registerSchema), asyncHandler(handlePendingRegistration));
router.post('/login', loginLimiter, validateRequest(loginSchema), asyncHandler(handleLogin));
